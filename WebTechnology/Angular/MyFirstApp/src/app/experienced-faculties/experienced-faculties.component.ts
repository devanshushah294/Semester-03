...
@Component({
  selector: 'app-experienced-faculties',
  templateUrl: './experienced-faculties.component.html',
  styleUrls: ['./experienced-faculties.component.css'],
})
export class ExperiencedFacultiesComponent {
  faculties = [
    {
      FacultyID: 1,
  ...
  experienced(str: String) {
    ...
    var experience = parseInt(splitted[0]);
    if (experience >= 10) {
      return true;
    } else {
      return false;
