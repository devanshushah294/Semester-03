...
const EmployeeAdd = () => {
  ...
  // return (
  //   <div className="pink-background pt-4">
  ...
  //     <button
  //       className="btn btn-primary m-center"
  //       onClick={() => {
  //         if (param.id > 0) {
  //           fetch(
  ...
  //         } else {
  //           fetch("https://630c662f53a833c53429c1c8.mockapi.io/Employee/", {
  //             method: "POST",
  //             body: JSON.stringify(data),
  //             headers: {
  //               "Content-Type": "application/json",
  ...
  return (
    <div className="pink-background height-100">
      <div className="background-white edit-add-window">
        <h1>
          {param.id > 0 && "Edit "}
          {!(param.id > 0) && "Add "}
          Employee
